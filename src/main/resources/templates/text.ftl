...
<!--[if lt IE 9]>
<link href="static/h-ui/static/h-ui/css/H-ui.ie.css" rel="stylesheet" type="text/css" />
<![endif]-->
<!--[if IE 6]>
	...
	<header class="navbar-wrapper">
		<div class="navbar navbar-black navbar-fixed-top">
			<div class="container cl">
				...
				<span class="logo navbar-slogan hidden-xs">简单 &middot; 免费 &middot; 适合中国网站</span>
		...
		<div id="slider-3">
			<div class="slider">
				<div class="bd">
					<ul>
						<li>
							<a href="http://www.h-ui.net/" target="_blank"><img src="static/h-ui/temp/banner1.jpg" ></a>
						</li>
						<li>
							<a href="http://www.h-ui.net/zhaoshang.shtml" target="_blank"><img src="static/h-ui/temp/banner2.jpg" ></a>
						</li>
						<li>
							<a href="http://h-ui.net/H-ui.admin.shtml" target="_blank"><img src="static/h-ui/temp/banner3.jpg" ></a>
						</li>
					</ul>
				</div>
				<ol class="hd cl dots">
		...
		<div class="container ui-sortable">
			...
			<div class="panel panel-default mt-20">
				...
				<div class="panel-body">
					...
					<div>
						<img src="static/h-ui/static/h-ui/images/ucnter/avatar-default.jpg" class="avatar radius size-MINI">
						<img src="static/h-ui/static/h-ui/images/ucnter/avatar-default.jpg" class="avatar radius size-S">
						<img src="static/h-ui/static/h-ui/images/ucnter/avatar-default.jpg" class="avatar radius size-M">
						<img src="static/h-ui/static/h-ui/images/ucnter/avatar-default.jpg" class="avatar radius size-L">
						<img src="static/h-ui/static/h-ui/images/ucnter/avatar-default.jpg" class="avatar radius size-XL">
					</div>
...
<script type="text/javascript" src="static/h-ui/lib/jquery-ui/1.9.1/jquery-ui.min.js"></script>
<script type="text/javascript" src="static/h-ui/static/h-ui/js/H-ui.js"></script>
<script type="text/javascript" src="static/h-ui/lib/jquery.SuperSlide/2.1.1/jquery.SuperSlide.min.js"></script>
<script type="text/javascript" src="static/h-ui/lib/jquery.validation/1.14.0/jquery.validate.min.js"></script>
<script type="text/javascript" src="static/h-ui/lib/jquery.validation/1.14.0/validate-methods.js"></script>
<script type="text/javascript" src="static/h-ui/lib/jquery.validation/1.14.0/messages_zh.min.js"></script>
<script>
//弹窗
function modaldemo(){
...
$(function(){
	...
	$("#star-1").raty({
		...
		path: 'static/h-ui/static/h-ui/images/star',//可以是相对路径
